...
from scikit_tt.tensor_train_modified import TT # pip install git+https://github.com/PGelss/scikit_tt
...
def plot_histogram(samples, probabilities):
    ...
    plt.bar(np.arange(samples.shape[0]), probabilities, tick_label=tick_label)
    plt.tight_layout()
    plt.show()
